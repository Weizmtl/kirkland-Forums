    ...
    <div class="comment-info">
      ...
      <div class="comment-content">
        <div>
          ...
          <span class="tag no-audit" v-if="commentData.status == 0">To be reviewed</span>
      ...
      <div class="op-panel">
        ...
        <div
          ...
          {{ commentData.goodCount > 0 ? commentData.goodCount : "Like" }}
        </div>
        <div
          ...
          <template #dropdown>
            <el-dropdown-menu>
              <el-dropdown-item @click="opTop(commentData)">
                {{ commentData.topType == 0 ? "Set to the top" : "untop" }}
              </el-dropdown-item>
            </el-dropdown-menu>
          </template>
        </el-dropdown>
...
const showReplyPanel = (curData, type) => {
  ...
  placeholderInfo.value = "Reply @" + curData.nickName;
};
